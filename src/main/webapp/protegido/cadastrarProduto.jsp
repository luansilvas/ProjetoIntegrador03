<%-- 
    ...
    Created on : 17/10/2020, 14:19:44
    Author     : luans
--%>
...
<html>
    ...
    <body>
        ...
        <div class="row" id="formulario">
            <form class="col s12" action="<c:url value="/CadastrarProduto"/>" method="POST">
                <div class="row">
                    ...
                    <div class="input-field col s4">
                        <input id="valor" type="text" class="validate" pattern="[0-9]{1,}.[0-9]{1,}" name="valor">
                        <label for="valor">Valor</label>
                    </div>
                    <div class="input-field col s4">
                        <input id="quantidade" type="number" class="validate" min="0" max="1000" name="quantidade">
