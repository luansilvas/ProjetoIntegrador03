    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (usuario.getCargo().equals("Vendedor")) {
                List<Cliente> clientes = ClienteDAO.getClientes(usuario.getCodUnidade());
                request.setAttribute("listaClientes", clientes);

                RequestDispatcher requestDispatcher = getServletContext().getRequestDispatcher("/protegido/listaCliente.jsp");
